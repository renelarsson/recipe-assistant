...
os.environ["RECIPE_INGESTION__CREDENTIALS__DATABASE"] = os.getenv("POSTGRES_DB")
os.environ["RECIPE_INGESTION__CREDENTIALS__USERNAME"] = os.getenv("POSTGRES_USER")
os.environ["RECIPE_INGESTION__CREDENTIALS__PASSWORD"] = os.getenv("POSTGRES_PASSWORD")
os.environ["RECIPE_INGESTION__CREDENTIALS__PORT"] = os.getenv("POSTGRES_PORT")
...
if os.getenv("POSTGRES_HOST") == "postgres":
    ...
    os.environ["RECIPE_INGESTION__CREDENTIALS__HOST"] = os.getenv("POSTGRES_HOST")
